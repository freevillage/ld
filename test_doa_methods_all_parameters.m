function test_doa_methods_all_parameters( fastRecordingTimeInPeriods, initialAltitude, clockShift, aspectAngle, sigmaNoise )

close all 
saveDirectory = '/scratch/poliann/mat_all_new';
isWaitbarShown = false;

saveFilename = sprintf( 'test_doa_results_%.0f_%.2f_%.2f_%.2f_%.2f.mat', fastRecordingTimeInPeriods, initialAltitude, clockShift, aspectAngle, log10(sigmaNoise) );
