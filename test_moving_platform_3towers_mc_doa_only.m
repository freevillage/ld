...
fastRecordingTimeShort = 10000 * fastSamplingPeriod;
...
for iSource = 1 : totalSources
    ...
    fastTimeIndices = 1:10000;
    
    for ks = 1 : totalSlowTimes
        recordedDataIsourceTrimmed = recordedDataIsource(:,:,fastTimeIndices,ks);
        recordedDataIsourceTrimmed2 = recordedDataIsource2(:,:,fastTimeIndices,ks);
...
orient landscape, print ( ['html/error_source_locations_',num2str(noiseSnr)], '-dpdf' )
