function test_doa_resolution_fasttime( fastRecordingTimeInPeriods, coeff, sigmaNoise )
...
if nargin < 3, sigmaNoise = 1e-7; end
...
slowTimeBeg = 0;
slowTimeEnd = 20 / coeff;
slowSamplingPeriod = (slowTimeEnd - slowTimeBeg) / 10;
...
saveFilename = fullfile( saveDirectory, sprintf( 'test_doa_results_%.0f_%.0f.mat', ...
    fastRecordingTimeInPeriods, log10( sigmaNoise ) ) );
