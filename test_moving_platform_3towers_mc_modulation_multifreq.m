...
freqMin = [300, 310, 320] * 10^6; % minimum possible frequency
freqMax = [305, 315, 325] * 10^6; % maximum possible frequency
...
downsampledFrequency = fastSamplingFrequency / ceil( fastSamplingFrequency/downsampledFrequency );
...
fastRecordingTimeShort = 4 * fastSamplingPeriod;
