function test_doa_methods_angle( fastRecordingTimeInPeriods, angleRadialAxis )

close all 
saveDirectory = '/scratch/poliann/mat_angle';
isWaitbarShown = false;

saveFilename = sprintf( 'test_doa_results_%.0f_%.2f.mat', fastRecordingTimeInPeriods, angleRadialAxis );
...
flightDirection = RotationMatrix3D( [0, 1, 0], angleRadialAxis ) * radialDirection;
