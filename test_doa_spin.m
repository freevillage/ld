function test_doa_spin( fastRecordingTimeInPeriods, initialAltitude, clockShift, aspectAngle, sigmaNoise, arraySpeed, arrayPerturbations )
...
%flightDirection, error( 'Blah' )

GetArrayPosition = @(t) initialArrayPosition + (arrayInitialSpeed) * t * flightDirection;
GetRotationAboutX = @(t) 2*pi*arrayAcceleration*t;
