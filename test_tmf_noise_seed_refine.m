...
sigmaNoise = logspace( -25, 0, 11 );
totalSigmas = length( sigmaNoise );

seeds = ToColumn( (1:1)+1000 );
    ...
    for jSigma = 1 : totalSigmas
        ...
        for kSeed = 1 : totalSeeds
            args = { ...
                ...
                'FourierWindowFunction', @(n) gausswin(n,n/5), ...
...
legendSigma = arrayfun( @num2str, fliplr( floor( dataSNR(1,:,1) ) ), 'UniformOutput', false );
