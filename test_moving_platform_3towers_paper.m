...
%
% 
%% Study of main factors affecting DOA supporters:
% 
% * Range
% * Frequency shift
% * Aspect angle
...
fastRecordingTimeShort = 1000 * fastSamplingPeriod;
...
for iSource = 1 : totalSources
    ...
    for ks = 1 : totalSlowTimes
        recordedDataIsourceTrimmed = recordedDataIsource(:,:,1:10,ks);
        recordedDataIsourceTrimmed2 = recordedDataIsource2(:,:,1:10,ks);
