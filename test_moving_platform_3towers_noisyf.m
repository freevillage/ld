...
for iSource = 1 : totalSources
    ...
    sourceTrue{iSource} = PolychromaticSource( ...
        sourcePosition(:,iSource), ...
        amplitudeSource(:,iSource), ...
        freqSource(:,iSource) + clockShiftAverage * RandomUniform( -1, 1, 1 ), ...
        phaseSource(iSource) );
end
...
GetArrayPosition = @(t) initialArrayPosition + arrayHorzSpeed * [ t; sin(t)/10; cos(t)/10 ];
...
%fastRecordingTimeLong = 100 * fastSamplingPeriod;
